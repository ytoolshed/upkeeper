...
\item 
{\bf upk\_\-svc\_\-desc\_\-t} $\ast$ {\bf lookup\_\-buddy\_\-from\_\-path} (char $\ast$buddy\_\-path)
\item 
...
\begin{center}
\leavevmode
\includegraphics[width=214pt]{ctrl__buddy_8c_a702a0c4cef2ab68a8567086357066d3c_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=258pt]{ctrl__buddy_8c_a702a0c4cef2ab68a8567086357066d3c_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=394pt]{ctrl__buddy_8c_a7bd4c4275367b7d6c5e5950928968c01_icgraph}
\end{center}
\end{figure}
...
References \_\-upk\_\-svc\_\-desc::Name, \_\-upk\_\-controller\_\-config::SvcRunPath, UPK\_\-MAX\_\-PATH\_\-LEN, and upk\_\-runtime\_\-configuration.
...
\begin{center}
\leavevmode
\includegraphics[width=270pt]{ctrl__buddy_8c_a3167c192e6ed5cd46f95d1a5d8848e7c_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{ctrl__buddy_8c_ab5645904078d1ac29f24cf8f6f9f95b3_cgraph}
\end{center}
\end{figure}
...
References \_\-upk\_\-controller\_\-config::controller\_\-buddy\_\-sock, \_\-upk\_\-controller\_\-config::controller\_\-socket, \_\-upk\_\-svc\_\-desc::CustomActions, fchmod(), \_\-upk\_\-cust\_\-actscr\_\-list::name, \_\-upk\_\-svc\_\-desc::Name, \_\-upk\_\-svc\_\-desc::ReloadScript, \_\-upk\_\-cust\_\-actscr\_\-list::script, \_\-upk\_\-svc\_\-desc::StartScript, \_\-upk\_\-svc\_\-desc::StopScript, \_\-upk\_\-controller\_\-config::SvcRunPath, \_\-upk\_\-cust\_\-actscr\_\-meta\_\-p::thisp, UPK\_\-MAX\_\-PATH\_\-LEN, upk\_\-runtime\_\-configuration, upk\_\-verbose, and UPKLIST\_\-FOREACH.
...
\begin{center}
\leavevmode
\includegraphics[width=240pt]{ctrl__buddy_8c_a0e91992d43a88269609df40068714512_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=268pt]{ctrl__buddy_8c_a0e91992d43a88269609df40068714512_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=228pt]{ctrl__buddy_8c_a1e00be01f0ecc2a3b84e03bae75e9bd8_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=358pt]{ctrl__buddy_8c_ac08a0cf9a291c08c1d7d25bab3fb789a_cgraph}
\end{center}
\end{figure}
...
\index{ctrl\_\-buddy.c@{ctrl\_\-buddy.c}!lookup\_\-buddy\_\-from\_\-path@{lookup\_\-buddy\_\-from\_\-path}}
\index{lookup\_\-buddy\_\-from\_\-path@{lookup\_\-buddy\_\-from\_\-path}!ctrl_buddy.c@{ctrl\_\-buddy.c}}
\subsubsection[{lookup\_\-buddy\_\-from\_\-path}]{\setlength{\rightskip}{0pt plus 5cm}{\bf upk\_\-svc\_\-desc\_\-t}$\ast$ lookup\_\-buddy\_\-from\_\-path (
\begin{DoxyParamCaption}
\item[{char $\ast$}]{buddy\_\-path}
\end{DoxyParamCaption}
)}\label{ctrl__buddy_8c_a5bb1452ac49e63b88f834fe2588f3850}


References \_\-upk\_\-svc\_\-desc::Name, \_\-upk\_\-controller\_\-config::svclist, upk\_\-svc\_\-desc\_\-meta\_\-p::thisp, UPK\_\-MAX\_\-PATH\_\-LEN, upk\_\-runtime\_\-configuration, and UPKLIST\_\-FOREACH.
...
\begin{center}
\leavevmode
\includegraphics[width=290pt]{ctrl__buddy_8c_a5bb1452ac49e63b88f834fe2588f3850_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=394pt]{ctrl__buddy_8c_a732e458dbb31507c5d6e25fe8051c526_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=374pt]{ctrl__buddy_8c_a885b8908c44426b410c5849bbf7ab9b1_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=244pt]{ctrl__buddy_8c_a885b8908c44426b410c5849bbf7ab9b1_icgraph}
\end{center}
\end{figure}
...
References closedir(), \_\-upk\_\-controller\_\-config::controller\_\-buddy\_\-sock, \_\-upk\_\-svc\_\-desc::CustomActions, \_\-upk\_\-cust\_\-actscr\_\-list::name, \_\-upk\_\-svc\_\-desc::Name, opendir(), readdir(), \_\-upk\_\-controller\_\-config::SvcRunPath, \_\-upk\_\-cust\_\-actscr\_\-meta\_\-p::thisp, UPK\_\-MAX\_\-PATH\_\-LEN, upk\_\-rm\_\-rf(), upk\_\-runtime\_\-configuration, upk\_\-verbose, and UPKLIST\_\-FOREACH.
...
\begin{center}
\leavevmode
\includegraphics[width=258pt]{ctrl__buddy_8c_a61bbd1a5bc18012f8087f8a9764ef409_cgraph}
\end{center}
\end{figure}
...
References buddy\_\-readstate(), select(), SHUT\_\-RDWR, shutdown(), and timeval::tv\_\-sec.
...
References buddy\_\-path(), buddy\_\-uuid, \_\-upk\_\-controller\_\-config::BuddyVerbosity, \_\-upk\_\-svc\_\-desc::Name, \_\-upk\_\-controller\_\-config::SvcRunPath, timespec::tv\_\-sec, upk\_\-fatal, UPK\_\-MAX\_\-PATH\_\-LEN, upk\_\-runtime\_\-configuration, UPK\_\-UUID\_\-STRING\_\-LEN, upk\_\-uuid\_\-to\_\-string(), upk\_\-verbose, \_\-upk\_\-controller\_\-config::UpkBuddyPath, and \_\-upk\_\-svc\_\-desc::UUID.
...
\begin{center}
\leavevmode
\includegraphics[width=254pt]{ctrl__buddy_8c_ad0312ac0cbebe30134d47757bc97ea47_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=232pt]{ctrl__buddy_8c_ad0312ac0cbebe30134d47757bc97ea47_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=386pt]{ctrl__buddy_8c_abac768e7b1b76398ad7e25e651f776ea_cgraph}
\end{center}
\end{figure}
