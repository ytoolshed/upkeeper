...
References accept(), buddy\_\-ctrlfd, buddy\_\-sockaddr\_\-len, buddy\_\-sockfd, fcntl(), sockopts, and upk\_\-debug1.
...
\begin{center}
\leavevmode
\includegraphics[width=204pt]{buddy_8c_a212050d7ce21747a29bdd07717001c53_cgraph}
\end{center}
\end{figure}
...
References buddy\_\-ctrlfd, SHUT\_\-RDWR, shutdown(), and upk\_\-debug1.
...
\begin{center}
\leavevmode
\includegraphics[width=234pt]{buddy_8c_ab07b428fcfd43a52fc80958d41187719_cgraph}
\end{center}
\end{figure}
...
\subsubsection[{buddy\_\-exec\_\-action}]{\setlength{\rightskip}{0pt plus 5cm}static {\bf pid\_\-t} buddy\_\-exec\_\-action (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
...
References BUDDY\_\-MAX\_\-PATH\_\-LEN, buddy\_\-path\_\-buf, buddy\_\-setreguid(), buddy\_\-setup\_\-fds(), buddy\_\-string\_\-buf, buddy\_\-supp\_\-groups(), proc\_\-envp, proc\_\-pid, sigaction::sa\_\-flags, sigaction::sa\_\-handler, sigaction::sa\_\-mask, sigaction(), sigemptyset(), sigfillset(), sigprocmask(), sigset(), stat::st\_\-mode, stat(), upk\_\-alert, upk\_\-debug0, and upk\_\-notice.
...
References buddy\_\-ctrlfd, buddy\_\-disconnect(), buddy\_\-zero\_\-info(), info\_\-ringbuffer, \_\-buddy\_\-info::next, phone\_\-home\_\-if\_\-appropriate(), \_\-buddy\_\-info::populated, read\_\-ctrl(), \_\-buddy\_\-info::remaining, ringbuffer\_\-pending, sigfillset(), sigprocmask(), sigset(), this\_\-command, UPK\_\-CTRL\_\-ACK, upk\_\-debug1, and write\_\-ctrl().
...
References free(), \_\-buddy\_\-info::next, and ringbuffer\_\-size.
...
\begin{center}
\leavevmode
\includegraphics[width=224pt]{buddy_8c_a881775ce0d44afe1ddf0c9b7d345db51_cgraph}
\end{center}
\end{figure}
...
References calloc(), \_\-buddy\_\-info::next, ringbuffer\_\-size, and \_\-buddy\_\-info::slot\_\-n.
...
\begin{center}
\leavevmode
\includegraphics[width=228pt]{buddy_8c_ae52b66d6f890174e6aada3ec2be81da3_cgraph}
\end{center}
\end{figure}
...
References bind(), buddy\_\-path(), buddy\_\-sockaddr, buddy\_\-sockaddr\_\-len, buddy\_\-sockfd, fcntl(), listen(), SOCK\_\-STREAM, socket(), sockaddr\_\-un::sun\_\-family, sockaddr\_\-un::sun\_\-path, umask(), and upk\_\-debug0.
...
Referenced by buddy\_\-cleanup(), buddy\_\-cust\_\-action(), buddy\_\-init(), buddy\_\-init\_\-socket(), buddy\_\-phone\_\-home(), buddy\_\-reload\_\-proc(), buddy\_\-setup\_\-fds(), buddy\_\-start\_\-proc(), buddy\_\-stop\_\-proc(), and spawn\_\-buddy().
...
References buddy\_\-ctrlfd, buddy\_\-path(), buddy\_\-sockaddr\_\-len, buddy\_\-string\_\-buf, connect(), resolve\_\-symlink(), SOCK\_\-STREAM, socket(), sockaddr\_\-un::sun\_\-family, and sockaddr\_\-un::sun\_\-path.
...
\begin{center}
\leavevmode
\includegraphics[width=344pt]{buddy_8c_a664f7a6d18dea51b1260b106a38ebb24_cgraph}
\end{center}
\end{figure}
...
References buddy\_\-uuid, buddy\_\-zero\_\-info(), \_\-buddy\_\-info::command, desired\_\-state, \_\-buddy\_\-info::desired\_\-state, last\_\-command, \_\-buddy\_\-info::populated, proc\_\-pid, ringbuffer\_\-pending, ringbuffer\_\-size, \_\-buddy\_\-info::service\_\-pid, \_\-buddy\_\-info::timestamp, upk\_\-debug1, and \_\-buddy\_\-info::uuid.
...
References buddy\_\-exec\_\-action(), buddy\_\-path(), buddy\_\-record\_\-state(), buddy\_\-service\_\-name, force\_\-ratelimit, MAX\_\-RESPAWN\_\-COUNT, \_\-buddy\_\-info::next, proc\_\-pid, rapid\_\-respawn\_\-count, RESPAWN\_\-RATELIMIT, respawn\_\-timestamp, RESPAWN\_\-WINDOW, sigaddset(), sigemptyset(), sigprocmask(), sigset(), upk\_\-debug0, and upk\_\-notice.
...
References buddy\_\-exec\_\-action(), buddy\_\-path(), proc\_\-pid, timespec::tv\_\-nsec, and timespec::tv\_\-sec.
...
\index{buddy.c@{buddy.c}!buddy\_\-supp\_\-groups@{buddy\_\-supp\_\-groups}}
\index{buddy\_\-supp\_\-groups@{buddy\_\-supp\_\-groups}!buddy.c@{buddy.c}}
\subsubsection[{buddy\_\-supp\_\-groups}]{\setlength{\rightskip}{0pt plus 5cm}static void buddy\_\-supp\_\-groups (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [inline, static]}}\label{buddy_8c_a996d3440ab95a25aaedbe25fde69705b}


References buddy\_\-setuid, clear\_\-supplemental\_\-groups, getpwuid(), initgroups(), initialize\_\-supplemental\_\-groups, and setgroups().
...
\begin{center}
\leavevmode
\includegraphics[width=244pt]{buddy_8c_a996d3440ab95a25aaedbe25fde69705b_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{buddy_8c_a996d3440ab95a25aaedbe25fde69705b_icgraph}
\end{center}
\end{figure}
...
References buddy\_\-phone\_\-home(), buddy\_\-shutdown, reconnect\_\-retries, ringbuffer\_\-pending, ringbuffer\_\-size, timespec::tv\_\-nsec, timespec::tv\_\-sec, and upk\_\-verbose.
...
References buddy\_\-build\_\-fd\_\-set(), buddy\_\-ctrlfd, buddy\_\-disconnect(), BUDDY\_\-SELECT\_\-TIMEOUT\_\-SEC, BUDDY\_\-SELECT\_\-TIMEOUT\_\-USEC, highest\_\-fd, ncount, select(), timeval::tv\_\-sec, and timeval::tv\_\-usec.
...
\begin{center}
\leavevmode
\includegraphics[width=328pt]{buddy_8c_a042568d6c2f703b98ba73eb6fc7e8edb_cgraph}
\end{center}
\end{figure}
...
References buddy\_\-path\_\-buf, buddy\_\-string\_\-buf, lstat(), and stat::st\_\-mode.
...
\begin{center}
\leavevmode
\includegraphics[width=204pt]{buddy_8c_aca04c1736459e680420f762c4ca81e84_cgraph}
\end{center}
\end{figure}
...
References buddy\_\-record\_\-state(), buddy\_\-shutdown, chld\_\-terminated, \_\-buddy\_\-info::next, proc\_\-pid, \_\-buddy\_\-info::siginfo, upk\_\-debug1, \_\-buddy\_\-info::wait\_\-pid, \_\-buddy\_\-info::wait\_\-status, and waitpid().
...
\subsubsection[{buddy\_\-setgid}]{\setlength{\rightskip}{0pt plus 5cm}{\bf gid\_\-t} {\bf buddy\_\-setgid}}\label{buddy_8c_a94f0c0963c51ae59585d090bd146267c}
...
\subsubsection[{buddy\_\-setuid}]{\setlength{\rightskip}{0pt plus 5cm}{\bf uid\_\-t} {\bf buddy\_\-setuid}}\label{buddy_8c_a2ef8d11cc4ac2862fbe8ce2112e2e4fb}
...
\index{buddy.c@{buddy.c}!clear\_\-supplemental\_\-groups@{clear\_\-supplemental\_\-groups}}
\index{clear\_\-supplemental\_\-groups@{clear\_\-supplemental\_\-groups}!buddy.c@{buddy.c}}
...
\index{buddy.c@{buddy.c}!initialize\_\-supplemental\_\-groups@{initialize\_\-supplemental\_\-groups}}
\index{initialize\_\-supplemental\_\-groups@{initialize\_\-supplemental\_\-groups}!buddy.c@{buddy.c}}
...
\subsubsection[{ncount}]{\setlength{\rightskip}{0pt plus 5cm}{\bf size\_\-t} {\bf ncount} = 0\hspace{0.3cm}{\ttfamily  [static]}}\label{buddy_8c_af750bbadf6e7e222f8d8b062e8696dd0}
...
\subsubsection[{proc\_\-pid}]{\setlength{\rightskip}{0pt plus 5cm}{\bf pid\_\-t} {\bf proc\_\-pid} = 0\hspace{0.3cm}{\ttfamily  [static]}}\label{buddy_8c_aa13c9951e918940d6f11d8ea9c2f4546}
...
\subsubsection[{rapid\_\-respawn\_\-count}]{\setlength{\rightskip}{0pt plus 5cm}{\bf uint32\_\-t} {\bf rapid\_\-respawn\_\-count} = 0\hspace{0.3cm}{\ttfamily  [static]}}\label{buddy_8c_ae618973dea04a018a21366805669ca73}
...
\subsubsection[{respawn\_\-timestamp}]{\setlength{\rightskip}{0pt plus 5cm}{\bf time\_\-t} {\bf respawn\_\-timestamp} = 0\hspace{0.3cm}{\ttfamily  [static]}}\label{buddy_8c_a585a8d637b449525b158a160771fb4b1}
...
\subsubsection[{ringbuffer\_\-pending}]{\setlength{\rightskip}{0pt plus 5cm}{\bf size\_\-t} {\bf ringbuffer\_\-pending} = 0\hspace{0.3cm}{\ttfamily  [static]}}\label{buddy_8c_af9029329735214e89a6493415ea518d8}
...
\subsubsection[{ringbuffer\_\-size}]{\setlength{\rightskip}{0pt plus 5cm}{\bf size\_\-t} {\bf ringbuffer\_\-size} = 32}\label{buddy_8c_aaf0b4e8526897974d594cc330ece0b5c}
...
\subsubsection[{timeout}]{\setlength{\rightskip}{0pt plus 5cm}struct {\bf timeval} {\bf timeout} = \{.tv\_\-sec = BUDDY\_\-SELECT\_\-TIMEOUT\_\-SEC,.tv\_\-usec = BUDDY\_\-SELECT\_\-TIMEOUT\_\-USEC \}\hspace{0.3cm}{\ttfamily  [static]}}\label{buddy_8c_a03a5df464f7f59f8fe9f8da62642ce06}
\index{buddy.c@{buddy.c}!user\_\-ratelimit@{user\_\-ratelimit}}
\index{user\_\-ratelimit@{user\_\-ratelimit}!buddy.c@{buddy.c}}
\subsubsection[{user\_\-ratelimit}]{\setlength{\rightskip}{0pt plus 5cm}{\bf uint32\_\-t} {\bf user\_\-ratelimit} = 0}\label{buddy_8c_ae27137b4c4b5c8be0a91356bfab19ee1}
