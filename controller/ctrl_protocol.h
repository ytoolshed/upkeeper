...
typedef enum {
    ...
    UPK_CTRL_ACTION_STOP,                                  /* run stop script, which should kill the monitored process */
    UPK_CTRL_ACTION_RELOAD,                                /* run reload script, which could, for example, send SIGHUP */
